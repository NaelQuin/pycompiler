...
public class ExprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "INT", "WS", "LOGICAL_OPERATOR", "NOT", 
			"NULL", "BOOLEAN", "RELATIONS", "NUMBER", "EQ", "NEQ", "GEQ", "LEQ", 
			"ATTRNAME", "ATTR_NAME_CHAR", "DIGIT", "ALPHA", "SYMBOLS", "TEXT", "STRING", 
			"ESC", "UNICODE", "HEX", "DOUBLE", "COMPLEX", "COMPLEX_VAR", "EXP"
		};
	}
