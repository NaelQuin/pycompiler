// Generated from /home/natanael/Documents/pyModules/pycompiler/Python3/PythonParser.g4 by ANTLR 4.13.1
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1261023220259094528L) != 0) || ((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & 11007L) != 0)) {
				...
				case 1:
					{
					setState(268);
					if (!(self.CheckVersion(2))) throw new FailedPredicateException(this, "self.CheckVersion(2)");
					setState(269);
					match(COMMA);
					setState(270);
					name();
				...
				case 2:
					{
					setState(273);
					if (!(self.CheckVersion(3))) throw new FailedPredicateException(this, "self.CheckVersion(3)");
					setState(274);
					match(AS);
					setState(275);
					name();
